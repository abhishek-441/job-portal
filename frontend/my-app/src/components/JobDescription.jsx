...
//             if(res.data.success){
//                 setIsApplied(true);
//                 const updatedSingleJob = {...singleJob, applications:[...singleJob.applications,{applicant:user?._id}]};  // tricky learn to hanlde UI when one method is not work
  ...
  const isApplied = Boolean(
    user?.id &&
      singleJob?.applications?.some(
        app => app.applicant?.toString() === user.id.toString()
      )
  )
